...
import com.coder.guoy.goodtimes.databinding.ActivityEqzBinding;
...
public class EQZActivity extends MvvmBaseActivity<ActivityEqzBinding> implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eqz);
        initRecyclerView();
        initView();
    }
    ...
    private void initRecyclerView() {
        adapter = new ImageMoreAdapter(EQZActivity.this);
        mLayoutManager = new GridLayoutManager(EQZActivity.this, 2);
    ...
    private void getNetData(String baseUrl, String url, int page) {
        ImageHelper.Helper(baseUrl, url, page)
                ...
                .subscribe(new Subscriber<List<ImageBean>>() {
                    ...
                    public void onNext(List<ImageBean> beanList) {
                        Log.i("imageUrl",""+beanList.get(0).getImageUrl());
