...
public class Data {
    ...
    public void loadFromNetwork(final String url, final int position, final String classType,
    ...
    public Subscription subscribeData(@NonNull Observer<List<ImageBean>> observer,
                                      final String url, final int position, final String classType,
                                      final String imageType) {
        if (cache == null) {
            ...
            Observable.create(new Observable.OnSubscribe<List<ImageBean>>() {
                ...
                public void call(Subscriber<? super List<ImageBean>> subscriber) {
                    ...
                    if (items == null) {
                        ...
                        loadFromNetwork(url, position, classType, imageType);
                    } else {
