...
public class CircleProgressView extends ProgressBar {
    ...
    private int mReachBarSize = DisplayUtil.dip2px(2); // 未完成进度条大小
    private int mNormalBarSize = DisplayUtil.dip2px(2); // 未完成进度条大小
    private int mReachBarColor = Color.parseColor("#108ee9"); // 已完成进度颜色
    private int mNormalBarColor = Color.parseColor("#FFD3D6DA"); // 未完成进度颜色
    private int mTextSize = DisplayUtil.sp2px(14); // 进度值字体大小
    ...
    private int mOuterSize = DisplayUtil.dip2px(1); // 外层圆环宽度
